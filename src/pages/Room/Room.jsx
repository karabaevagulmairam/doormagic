        ...
        <section className='room'>
            <div className="container">
                ...
                <div className="room__row">
                    ...
                    {
                        user.orders?.order?.length > 0 ? (
                            <div>
                                <h2 className="room__form-title">Мои заказы</h2>
                                <table className="room__table">
                                    ...
                                    {user.orders.order.map((item, index) => (
                                        <tr className="room__table-info" key={index}>
                                            <td className="room__table-product">
                                                <img src={item.image} alt="" />
                                                {item.title}
                                            </td>
                                            <td className="room__table-product">{item.price}</td>
                                            <td className="room__table-product">16.08.2023</td>
                                            <td className="room__table-product">Ожидается</td>
                                        </tr>
                                    ))}
                                </table>
                                <Link to={'/myOrder'} className="room__all">
                                    Смотреть все
                                </Link>
                            </div>
                        ) : (
                            <p className='room__p'>У вас нет оформленных заказов.</p>
                        )
                    }
