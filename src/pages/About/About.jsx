        ...
        <div className="about">
            <div className="container">
                ...
                <p className="about__desc">
                    ...
                    А среди издательских брендов, которые представлены в DEEPMAG.kg есть: «БОМБОРА», «Corpus», «Mainstream», «Редакция Елены Шубиной», «Вилли-Винки», «Fanzon», «Комильфо» и «Канц-Эксмо». И мы постоянно пополняем эти списки.
                </p>
                ...
                <p className="about__desc">
                    ...
                    Мы рассказываем о книгах в нашем блоге, нам дают рекомендации знаменитости, а наши подборки составляют профессиональные редакторы. <br/><br/>
                    Мы регулярно проводим интересные акции и конкурсы, участие в которых гарантирует выгодные покупки. <br/>
                    Наши клиенты также могут рассчитывать на персональные скидки, подарки, кэшбэк по программе лояльности. <br/>
                    Специальные скидки доступны и сотрудникам компаний-партнёров.
                </p>
                ...
                <p className="about__desc">
                    Искандарова Тансулуу и Карабаева Гулмайрам
                </p>
            </div>
        </div>
    );
